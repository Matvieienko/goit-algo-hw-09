...
![Результати виконання](test.png)

## Жадібний алгоритм:
- Простий у реалізації.
- Виконується швидше при великих значеннях суми.
- Може не забезпечувати оптимального рішення для нестандартних наборів монет.

## Алгоритм динамічного програмування:
- Завжди знаходить оптимальне рішення.
- Вимагає більше обчислювальних ресурсів та часу.
- Є ефективним для довільних наборів монет, незалежно від їхніх співвідношень.

## Висновки:
- Жадібний алгоритм працює швидше, але не завжди дає оптимальний результат.
- Динамічне програмування забезпечує універсальність і точність, але має більші часові витрати.